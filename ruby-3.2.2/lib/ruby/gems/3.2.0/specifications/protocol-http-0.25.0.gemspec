# -*- encoding: utf-8 -*-
# stub: protocol-http 0.25.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Samuel Williams".freeze, "Bruno Sutic".freeze, "Herrick Fang".freeze, "Bryan Powell".freeze, "Dan Olson".freeze, "Genki Takiuchi".freeze, "Olle Jonsson".freeze, "Yuta Iwama".freeze]
